                        ...
                        <Row>
                            ...
                            <Col md={4}>
                                <Card className="card shadow p-2 mt-4">
                                    <Card.Body className="portfolio-card-body">
                                        ...
                                        <Row>
                                            <a href="https://seaba55.github.io/code-quiz/"><img className="img-fluid shadow" src="images/Coding-Quiz.gif" alt="coding-quiz" /></a>
                                        </Row>
                                        <Row className="mt-2 justify-content-center">
                                            {/* <!-- Gi/t Hub Profile Link --> */}
                                            <a className="portlolio-link" href="https://github.com/SeaBa55/code-quiz"><i className="fab fa-github fa-1x"></i></a>
                                        </Row>
                                    </Card.Body>
                                </Card>
                            </Col>  
                            ...
                            <Col md={4}>
                                <Card className="card shadow p-2 mt-4">
                                    <Card.Body className="portfolio-card-body">
                                        <Card.Title className="portfolio-card-title">
                                            <h6>Burger Tracker - Web App</h6>
                                        </Card.Title>
                                        <Row>
                                            <a href="https://young-ocean-90529.herokuapp.com/"><img className="img-fluid shadow" src="images/Burgers!.gif" alt="work-day-scheduler" /></a>
                                        </Row>
                                        <Row className="mt-2 justify-content-center">
                                            {/* <!-- Git Hub Profile Link --> */}
                                            <a className="portlolio-link" href="https://github.com/SeaBa55/burger"><i className="fab fa-github fa-1x"></i></a>
                                        </Row>
                                    </Card.Body>
                                </Card>
                            </Col>  
